...
class Scheduler:
    ...
    def already_executed(self, period_key: str, action: str, date_str: str) -> tuple[bool, Optional[str]]:
        """
    ...
    def record_execution(self, period_key: str, action: str, date_str: str, result_json: Optional[str] = None) -> None:
        """
        记录时间段的 action 执行
        ...
        """
        self.storage.record_period_execution(date_str, period_key, action, result_json)
