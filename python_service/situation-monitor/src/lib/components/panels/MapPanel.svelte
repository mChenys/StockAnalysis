...
<Panel id="map" title="全球态势" {loading} {error}>
	<div class="map-container" bind:this={mapContainer}>
		...
		<div class="map-legend">
			<div class="legend-header">地缘与宏观风险 (对股市影响)</div>
			<div class="legend-item" title="地缘冲突、黑天鹅事件或重大制裁，极可能导致大盘剧烈波动/暴跌">
				<span class="legend-dot high"></span> <b>高风险：</b>地缘黑天鹅/系统性风险
			</div>
			<div class="legend-item" title="区域动荡或政策预期转向，将导致相关板块波动加剧">
				<span class="legend-dot elevated"></span> <b>中风险：</b>局部动荡/市场波动预警
			</div>
			<div class="legend-item" title="局势整体受控，宏观面平稳，对市场无明显压制">
				<span class="legend-dot low"></span> <b>低风险：</b>宏观环境平稳可控
			</div>
			<div class="legend-footer">※ 指标整合了地缘政治、网络攻击与军事动向对金融市场的潜在扰动</div>

			<div class="legend-header mt-3">关键要素说明</div>
			<div class="legend-item" title="全球主要军事基地分布">
				<div class="symbol-box">
					<svg width="12" height="12" viewBox="0 0 10 10">
						<path d="M5,0 L6.5,3.5 L10,3.5 L7.5,6 L8.5,10 L5,7.5 L1.5,10 L2.5,6 L0,3.5 L3.5,3.5 Z" fill="#ff00ff" opacity="0.8" />
					</svg>
				</div> 军事基地 / 驻军点
			</div>
			<div class="legend-item" title="海上航运枢纽与贸易命脉">
				<div class="symbol-box">
					<svg width="12" height="12" viewBox="0 0 10 10">
						<rect x="1" y="1" width="8" height="8" fill="#00aaff" opacity="0.8" transform="rotate(45,5,5)" />
					</svg>
				</div> 航运要道 / 贸易枢纽
			</div>
			<div class="legend-item" title="全球互联网海底光缆关键登陆点">
				<div class="symbol-box">
					<svg width="12" height="12" viewBox="0 0 10 10">
						<circle cx="5" cy="5" r="3" fill="none" stroke="#aa44ff" stroke-width="1.5" />
					</svg>
				</div> 海底光缆登陆点
			</div>
			<div class="legend-item" title="核设施与能源敏感地带">
				<div class="symbol-box">
					<svg width="12" height="12" viewBox="0 0 12 12">
						<circle cx="6" cy="6" r="2" fill="#ffff00" />
						<circle cx="6" cy="6" r="5" fill="none" stroke="#ffff00" stroke-width="1" stroke-dasharray="2,2" />
					</svg>
				</div> 核能 / 敏感能源设施
			</div>
			<div class="legend-item" title="当前正在发生的热点冲突或危机">
				<div class="symbol-box">
					<span class="symbol-indicator pulse-static"></span>
				</div> 实时热点 / 危机事件
			</div>
		</div>
	</div>
