...
content = content.replace(`    async pushMarketAlert(analysisData) {
        const methods = [`, replacement1);

const replacement2 = `    async pushViaCorpWeChat(data) {
...
content = content.replace(`    async pushViaCorpWeChat(data) {
